...
* Fix ProfilePage side buttons being too close to popup border [#156](https://github.com/noahh-sdk/NodeIDs/pull/156)
* Fix detail HSV & split text buttons being offscreen [#154](https://github.com/noahh-sdk/NodeIDs/pull/154)
...
* Fixed all layers button not appearing [#149](https://github.com/noahh-sdk/NodeIDs/pull/149)

## v1.22.0
* Updated to Noahh 5.0.0 and GD 2.2081
* Added GJLevelScoreCell, GJRequestCell, GJUserCell, LikeItemLayer, FRequestProfilePage and SetIDPopup [#134](https://github.com/noahh-sdk/NodeIDs/pull/134)
* Added SetupObjectOptionsPopup IDs [#135](https://github.com/noahh-sdk/NodeIDs/pull/135)
* Added SetupOpacityPopup and ConfigureHSVWidget IDs [#136](https://github.com/noahh-sdk/NodeIDs/pull/136)
* Added a layout for hide menu in EndLevelLayer [#138](https://github.com/noahh-sdk/NodeIDs/pull/138)
* Added a layout to PauseLayer center button menu [#144](https://github.com/noahh-sdk/NodeIDs/pull/144)
* Implemented custom node container for EndLevelLayer to resolve label overlap issues across the noahh index [#137](https://github.com/noahh-sdk/NodeIDs/pull/137)

## v1.21.0
* Updated to Noahh 4.6.0 (iOS jitless support)
* Added SetupMoveCommandPopup IDs [#126](https://github.com/noahh-sdk/NodeIDs/pull/126)
* Added TutorialLayer IDs [#124](https://github.com/noahh-sdk/NodeIDs/pull/124)
* Added PurchaseItemPopup IDs [#128](https://github.com/noahh-sdk/NodeIDs/pull/128)
* Fixed Delete Filter buttons being too small [#123](https://github.com/noahh-sdk/NodeIDs/pull/123)
* Improved ProfilePage stats positioning [#127](https://github.com/noahh-sdk/NodeIDs/pull/127)

## v1.20.1
* Added iOS support

## v1.20.0
* Added IDs for sprites in EditorUI [#122](https://github.com/noahh-sdk/NodeIDs/pull/122)
* Fixed small visual bugs in Editor Delete Menu [#121](https://github.com/noahh-sdk/NodeIDs/pull/121)

## v1.19.0
* Added StarInfoPopup IDs [#115](https://github.com/noahh-sdk/NodeIDs/pull/115)
...
* Added LevelAreaLayer and SecretLayer3 and SecretLayer6 [#113](https://github.com/noahh-sdk/NodeIDs/pull/113)
* Fixed LevelPage IDs on non-level pages
* Updated about.md

## v1.17.0
* Added ItemInfoPopup [#111](https://github.com/noahh-sdk/NodeIDs/pull/111)
* Added SecretLayer and SecretLayer4 (2.0 vault and Chamber of Time) [#109](https://github.com/noahh-sdk/NodeIDs/pull/109)
* Fixed replaceInput not inheriting number input property [#110](https://github.com/noahh-sdk/NodeIDs/pull/110)
...
* Added SecretLayer2 (thanks @MuhXd [#98](https://github.com/noahh-sdk/NodeIDs/pull/98))
* Fixed parental control crash in InfoLayer while loading comments (thanks @SpaghettDev [#94](https://github.com/noahh-sdk/NodeIDs/pull/94))
...
* Fixed EditorPauseLayer issues (thanks @Alphalaneous [#95](https://github.com/noahh-sdk/NodeIDs/pull/95))

## v1.12.0

 * Bump Noahh to v3.0.0-beta.1
 ...
 * Added ShardsPage, DemonFilterSelectLayer, LevelListLayer, LevelListCell & MoreSearchLayer (thanks @RayDeeUx, [#50](https://github.com/noahh-sdk/NodeIDs/pull/50))
 * Added GJGroundLayer & MenuGameLayer (thanks @TheSillyDoggo, [#56](https://github.com/noahh-sdk/NodeIDs/pull/56))
 * Tweak the positioning of `bottom-menu` in `CreatorLayer` (@acaruso-xx, [#53](https://github.com/noahh-sdk/NodeIDs/pull/53))
...
## v1.8.0
* charactercolorpage :D by @Weebifying in [#27](https://github.com/noahh-sdk/NodeIDs/pull/27)
* Implement SecretRewardsLayer (chest room) by @MaSp005 in [#28](https://github.com/noahh-sdk/NodeIDs/pull/28)
* LevelEditorLayer.cpp implemented and PlayLayer.cpp modified by @Termantita in [#31](https://github.com/noahh-sdk/NodeIDs/pull/31)
...
* Bump Noahh version requirement to beta.20+
